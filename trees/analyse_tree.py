...
mass_rec = ROOT.TH1F("mass", "mass", 100, 2.96, 3.04)
losepoint = ROOT.TH1F("losepoint", "losepoint", 3, 0.5, 3.5)
...
top_mass = ROOT.TH1F("top_mass", "top_mass", 100, 2.96, 3.04)
top_losepoint = ROOT.TH1F("top_losepoint", "top_losepoint", 3, 0.5, 3.5)
top_chi2 = ROOT.TH1F("top_chi2", "top_chi2", 100, 0, 100)


df_mc = uproot.open("TrackedKinkTree.root")["MCTree"].arrays(library="pd")
df_rec = uproot.open("TrackedKinkTree.root")["KinkTree"].arrays(library="pd")
...
fill_th1_hist(df_rec, "gLosePoint", losepoint)
...
fill_th1_hist(df_topology, "gLosePoint", top_losepoint)
...
## efficiency plots
eff_algo = mother_pt.Clone("eff_algo_pt")
eff_algo.Divide(mc_mother_pt)
eff_algo.SetStats(0)
...
eff_algo_rad = top_mother_pt.Clone("eff_algo_rad")
eff_algo_rad.Divide(mc_daughter_pt)
eff_algo_rad.SetStats(0)
eff_algo_rad.GetYaxis().SetTitle("Reconstruction efficiency")
